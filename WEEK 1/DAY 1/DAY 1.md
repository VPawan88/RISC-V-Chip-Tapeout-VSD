...
1️⃣ **Write RTL Code**  
2️⃣ **Prepare a Synthesis Script**  
3️⃣ **Choose a Target Library**  
4️⃣ **Run Synthesis**

---

### 🔀 What is a Multiplexer (MUX)?
A Multiplexer (MUX) is a combinational circuit that selects one of several inputs and forwards it to a single output line—like a digital switch.
